...
const sendVerificationEmail = async (email, token) => {
    ...
    const mailOptions = {
        ...
        text: `Please click the following link to verify your email address: https://hospital-management-system-six-snowy.vercel.app/verify/${token}`,
        html: `<p>Please click this link to verify your account:</p> <a href="https://hospital-management-system-six-snowy.vercel.app/verify/${token}">Verify</a>`,
    };
