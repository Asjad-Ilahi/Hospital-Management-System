...
function EditUser() {
  ...
  const getUserById = async () => {
    const response = await axios.get(`https://hospital-management-system-six-snowy.vercel.app/users/${id}`, {
      headers: {
  ...
  const updateUser = async (e) => {
    e.preventDefault();
    try {
      await axios.patch(`https://hospital-management-system-six-snowy.vercel.app/users/${id}`,
        {
          firstName,
          lastName,
          username,
