...
function PatientProfile() {
  ...
  const getPatientById = async () => {
    ...
    const response = await axios.get(`https://hospital-management-system-six-snowy.vercel.app/profile/patient/${patientUserId}`);
  ...
  const updatePatient = async (e) => {
    e.preventDefault();
    try {
      await axios.patch(`https://hospital-management-system-six-snowy.vercel.app/patients/${patientId}`, {
        firstName,
        lastName,
        username,
        email,
