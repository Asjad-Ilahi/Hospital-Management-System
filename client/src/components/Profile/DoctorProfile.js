...
function DoctorProfile() {
    ...
    const getdoctorById = async () => {
        ...
        const response = await axios.get(`https://hospital-management-system-six-snowy.vercel.app/profile/doctor/`+doctorUserId);
    ...
    const updatedoctoruser = async (e) => {
        ...
        try {
            await axios.patch(`https://hospital-management-system-six-snowy.vercel.app/profile/doctor/${doctorId}`, {
                firstName,
                lastName,
                username,
                email,
