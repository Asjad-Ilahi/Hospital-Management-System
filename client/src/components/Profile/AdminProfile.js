...
function AdminProfile() {
  ...
  const getAdminById = async () => {
    ...
    const response = await axios.get(`https://hospital-management-system-six-snowy.vercel.app/profile/admin/${adminUserId}`);
  ...
  const updateAdmin = async (e) => {
    ...
    //alert(userId);
    try {
      await axios.patch(`https://hospital-management-system-six-snowy.vercel.app/profile/admin/${userId}`, {
        firstName,
        lastName,
        username,
        email,
